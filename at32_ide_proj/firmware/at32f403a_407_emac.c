...
{
	printf("Within emac_control_para_init");
  ...
  control_para->watchdog_disable = FALSE;
	printf("Out of emac_control_para_init");
}
...
{
	printf("Within eamc_dma_software_reset_set.");
  EMAC_DMA->bm_bit.swr = 1;
	printf("Out of eamc_dma_software_reset_set.");
}
...
{
	printf("Within eamc_dma_software_reset_get.");
